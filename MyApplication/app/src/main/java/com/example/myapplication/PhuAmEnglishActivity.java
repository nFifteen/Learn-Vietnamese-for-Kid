...
public class PhuAmEnglishActivity extends AppCompatActivity {
    GifImageView gif_next, gif_back;
    ImageView img_lesson, img_home;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phu_am_english);
        ...
        gif_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PhuAmEnglishActivity.this);
                builder.setMessage("Bé có muốn chuyển sang học bảng chữ cái?");
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent van = new Intent(getApplicationContext(), AlphaEnglishActivity.class);
                        startActivity(van);
                    }
                });
        ...
        gif_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent na = new Intent(getApplicationContext(), NguyenAmTiengAnhActivity.class);
                        startActivity(na);
                    }
                });
                builder.setNegativeButton("Không", new DialogInterface.OnClickListener() {
