...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        cv_daoduc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog_hoctap.setVisibility(View.GONE);
                dialog_ontap.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent ontap = new Intent(getApplicationContext(), ReviewDaoDucActivity.class);
                        startActivity(ontap);
                    }
                });
            }
        ...
        cv_tienganh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog_hoctap.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent hoctap = new Intent(getApplicationContext(),EnglishLessonActivity.class);
                        startActivity(hoctap);
                    }
                });
                dialog_ontap.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent ontap = new Intent(getApplicationContext(),EnglishReviewActivity.class);
                        startActivity(ontap);
                    }
                });
            }
        });
        cv_toan.setOnClickListener(view -> {
            Dialog dialog = new Dialog(HomeActivity.this);
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            dialog.setContentView(R.layout.dialog_lesson);
            ...
            dialog_hoctap.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent hoctap = new Intent(getApplicationContext(),LessionMathActivity.class);
                    startActivity(hoctap);
                }
            });
            dialog_ontap.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent ontap = new Intent(getApplicationContext(),ReviewMathActivity.class);
                    startActivity(ontap);
                }
            });
        });
    ...
    private void mapping() {
        ...
        cv_toan = findViewById(R.id.cv_toan);
    }
